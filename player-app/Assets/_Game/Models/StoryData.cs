...
namespace InteractiveFantasticTales.Models
{
    ...
    [Serializable] public class CharacterCreationData { public Dictionary<string, AttributeDef> attributes; public int startingGold; public List<string> startingItems; public int startingProvisions; }
    ...
    [Serializable] public class ItemDefinition { public string type; public string description; public Dictionary<string, int> effects; }
    ...
    [Serializable] public class OnEnterData { public List<string> addItems; public List<string> removeItems; public Dictionary<string, object> setFlags; public int modifyGold; public int modifyStamina; public int modifyLuck; }
