...
namespace InteractiveFantasticTales.Models
{
    ...
    public class Character
    {
        ...
        {
            stamina = Math.Clamp(stamina + delta, 0, maxStamina);
        }

        public void ModifyLuck(int delta)
        {
            luck = Math.Clamp(luck + delta, 0, maxLuck);
        }
        ...
        {
            return flags.ContainsKey(flag) && flags[flag] is bool b && b;
        }
